...
Operators - verious operations perfomed with Java operators. 

SiteLoader - we connected to the website of the national bank and requested the exchange rate. Implemented saving the received courses to a file. When starting the program, given
possibility for the user to the file to save the course. Otherwise the course must be saved near to the program being launched. 
